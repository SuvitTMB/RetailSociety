...
function CheckEndAuction() {
  ...
  .get().then((snapshot)=> {
    snapshot.forEach(doc=> {
      ...
      var xPost = '<div style="font-size:13px;"><b>'+doc.data().AuctionName+'</b></div><div style="font-size:12px;"><b>'+doc.data().EmpName+'</b></div><div style="font-size:12px;">Date '+ doc.data().LastDateAuction +'</div>';
