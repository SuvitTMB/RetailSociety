...
function ShowLike() {
  ...
  snapshot.forEach(doc=> {
    ...
    if(i==0) {
      str = '<div style="border:1px solid #ccc; background-color: #f1f1f1; border-radius: 10px;padding:20px;text-align: center;width:100%;">ยังไม่มีกำลังใจจากเพื่อนของเรา</div>';
    }
